...
export const MacbookScroll = ({
  ...
  const scaleMax = isMobile ? 0.2 : 0.3;
  ...
  const translateY = useTransform(
    scrollYProgress,
    [0, isMobile ? 0.1 : 0.3, isMobile ? 0.2 : 0.5, 1],
    [0, 480, 680, 680]
  );
  ...
  const rotate = useTransform(
    scrollYProgress,
    [isMobile ? 0.05 : 0.1, isMobile ? 0.06 : 0.12, scaleMax],
    [-28, -28, 0]
  );
  const textTransform = useTransform(scrollYProgress, [0, scaleMax], [0, 100]);
  const textOpacity = useTransform(scrollYProgress, [0, isMobile ? 0.1 : 0.2], [1, 0]);
